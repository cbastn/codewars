...
function findNeedle(haystack) {
  // this function finds the position of the string 'needle' in the haystack array

  for(let i = 0; i < haystack.length;i++){

      //loop through hackstay array keeping track of position
      if(haystack[i] == 'needle'){
          //check each position for the string 'needle' 
