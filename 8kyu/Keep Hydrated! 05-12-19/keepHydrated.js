...
//function takes in time, returns liters of water rounded down 
const litres=(time)=> Math.floor(time * 0.5);

  //This can be done in one like by multiplying the time by 0.5
  //Then rounding down with Math.floor function 
